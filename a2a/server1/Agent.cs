...
using Request = Server1.Models.Request;
...
namespace Server1
{
	public class Agent
	{
		...
		private readonly string SystemPrompt = "You are a scientific calculator agent. You can only perform log and exp operations. Log is the to base e. You cannot perform any other operation. The query may or may not contain some context. If context is available, use the information in the context to answer the query.";
		public Agent()
		{
