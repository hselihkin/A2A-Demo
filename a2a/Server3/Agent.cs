...
using Request = Server3.Models.Request;
...
namespace Server3
{
    public class Agent
    {
        ...
        private readonly string SystemPrompt = "You are a trigonometric agent. You can only perform sine, cos and tan operations. Assume all input is in degrees. You cannot perform any other operation. The query may or may not contain some context. If context is available, use the information in the context to answer the query.";
        public Agent()
        {
